        ...
        <div className="w-full h-screen bg-gradient-to-t from-sky-500/50 to-blue-800">
            <div className="flex justify-center items-center h-screen">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className=" shadow-md  p-6 rounded-lg bg-pink-300 bg-gradient-to-br from-cyan-500 to-slate-700 ">
                        <div className="flex flex-col justify-center items-center space-y-3">
                            <h2 className="text-2xl font-bold bg-gradient-to-t from-gray-800 to-red-500 inline-block bg-clip-text text-transparent py-4">Login</h2>
                            ...
                            <input type="text" className="h-10 w-64 text-center bg-blue-600  text-white focus:bg-green-900 " name="password" placeholder="Your email address" id="" />
                            ...
                            <button className="bg-green-600 hover:bg-green-700 hover:border px-5 py-1 rounded-sm text-white">Login</button>
                        </div>
                        <h2 className="text-xs text-right pr-4 py-4">Dont have an account. Please <Link to="/register" className="font-bold">register</Link></h2>
